var CavitationControllerModule = (function() {
    var VERSION = '2.0.0';
    var MODULE_NAME = 'cavitation_controller';
    var ENDPOINT = '/api/turbine_controller';
    var FEATURES = ['mpc_solve', 'feedforward_compensation', 'thread_safe'];
