var RobotPlannerModule = (function() {
    var VERSION = '2.0.0';
    var MODULE_NAME = 'robot_planner';
    var ENDPOINT = '/api/robot_planner';
    var FEATURES = ['rrt_star', 'dynamic_positioning', 'trajectory_generation', 'marching_squares'];
