var AcousticFingerprintModule = (function() {
    var VERSION = '2.0.0';
    var MODULE_NAME = 'acoustic_fingerprint';
    var ENDPOINT = '/api/acoustic_diagnosis';
    var FEATURES = ['gpu_feature_extract', 'denoise_autoencoder', 'metric_learning', 'online_clustering'];
    return { VERSION: VERSION, NAME: MODULE_NAME, ENDPOINT: ENDPOINT, FEATURES: FEATURES };
})();
