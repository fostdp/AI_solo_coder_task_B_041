var PlantSchedulerModule = (function() {
    var VERSION = '2.0.0';
    var MODULE_NAME = 'plant_scheduler';
    var ENDPOINT = '/api/unit_scheduler';
    var FEATURES = ['milp', 'min_stable_time', 'async_schedule', 'cavitation_weighted'];
